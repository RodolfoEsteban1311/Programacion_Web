          ...
          <div class="card">
            <div class="card-body">
              <form action="./functions/insert.php" method="post">
                <div class="mb-3">
                  <label class="form-label">Nombre estatus</label>
              ...
              <table class="table">
                ...
                ?>
                      <tr>
                          ...
                          <td>
                              <?php echo $fila[ 'nombre_estatus' ]; ?>
                          </td>
                          <td><a href="./view/update_form.php?id=<?php echo $fila[ 'id_estatus' ]; ?>"><i class="bi bi-pencil-square text-warning"></i></a></td>
                          <td><a href="./functions/delete.php?id=<?php echo $fila[ 'id_estatus' ]; ?>"><i class="bi bi-trash2-fill text-danger"></i></a></td>
                      </tr>
                      <?php $contador++;
                  } ?>
                </tbody>
